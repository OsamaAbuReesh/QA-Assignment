...
public class ProductStock {
     ...
     */
    public ProductStock(String productId, String location, int initialOnHand, int reorderThreshold, int maxCapacity) {
    ...
    public void removeDamaged(int amount) {
        ...
        onHand -= amount; // reserved is unchanged here
        if (reserved > onHand) { // Safety: never allow reserved > onHand
            reserved = onHand;
        }
    }
    ...
    public String toString() {
        return "ProductStock{" + "productId='" + productId + '\'' + ", location='" + location + '\'' + ", onHand=" + onHand + ", reserved=" + reserved + ", available=" + getAvailable() + ", reorderThreshold=" + reorderThreshold + ", maxCapacity=" + maxCapacity + '}';
    }
}
